import { CheckCircle2, Mail, Calendar, ArrowRight, HelpCircle } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 bg-muted px-4 py-2 rounded-full">
            ...
            <span className="text-sm text-muted-foreground">While you wait, here are answers to common questions</span>
          </div>
        </div>
        <PartnerFAQSection showHeader={false} className="py-0" />
      </div>
    </div>
  );
};
