...
export function EnhancedUserManagement() {
  ...
  const roleColors = {
    ...
    partner: "bg-fuchsia-500/10 text-fuchsia-500 border-fuchsia-500/30",
  };
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-fuchsia-500">{partners.length}</p>
              </div>
      ...
      <Tabs defaultValue="roles" className="space-y-4">
        ...
        <TabsContent value="partners" className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-500/5 to-fuchsia-500/10">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                      ...
                      {filteredPartners.map((partner) => {
                        ...
                        return (
                          <TableRow key={partner.id}>
                            <TableCell>
                              <code className="text-xs bg-fuchsia-500/10 text-fuchsia-500 px-2 py-1 rounded font-mono">
                                {partner.id}
                              </code>
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell className="text-right">
                              <div className="flex items-center justify-end gap-1">
                                <IndianRupee className="w-3 h-3 text-fuchsia-500" />
                                <span className={`font-semibold ${earnings.total_earned > 0 ? "text-fuchsia-500" : "text-muted-foreground"}`}>
